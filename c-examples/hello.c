...
unsigned char index;
const unsigned char TEXT[] = {"Hoodlum Industries!"};
const unsigned char PALETTE[] = {COLOR_BLACK, COLOR_WHITE, COLOR_WHITE, COLOR_WHITE};

void SET_PPU_ADDRESS(unsigned char high, unsigned char low)
{
    PPU_ADDRESS = high;
    PPU_ADDRESS = low;
}
